 ...
 */
package com.mycompany.practica1_1.Dominio.Usuario;

import com.mycompany.practica1_1.Persistencia.UsuarioDAO;
...
public class UsuarioService {
    ...
    public void crearUsuario(String correoElectronico, String clave) throws Exception {
        ...
        try {
            ...
            if (dao.buscarUsuarioPorEmail(correoElectronico) != null) {
    ...
    public Usuario buscarUsuarioPorCorreoElectronico(String correoElectronico) throws Exception {
        ...
        try {
            ...
            Usuario usuario = dao.buscarUsuarioPorEmail(correoElectronico);
